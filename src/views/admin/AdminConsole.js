    ...
    return (
        ...
        >
            <Grid item xs={12} gap={1} sx={{pt: 2, pb: 2, display: 'flex'}}>
                <Button
                    onClick={() => handleViewChange({quiz: true, stats: false, admin: false})}
                    variant='contained'
                    color='secondary'
                ...
                <Button
                    onClick={() => handleViewChange({quiz: false, stats: true, admin: false})}
                    variant='contained'
                    color='secondary'
                ...
                <Button
                    onClick={() => handleViewChange({quiz: false, stats: false, admin: true})}
                    variant='contained'
                    color='secondary'
            ...
            <Grid item container spacing={0} sx={{height: "100vh", width: "100vw"}}>
                ...
                <Grid item xs={12} sm={view.admin ? 12 : 9} md={view.admin ? 12 : 9} sx={{p: view.admin ? 0 : '3rem'}}>
