        ...
        >
            ...
            >
                {questionnaires.map(quiz => (
                    <QuizBox key={quiz.id} quiz={quiz} goToQuestionnaire={goToQuestionnaire}/>
                ))}

            </Grid>
            <ConsentModal open={openConsentPopup} setOpen={setOpenConsentPopup} qId={selectedQuestionnaire}/>
        </Grid>
    );
};
