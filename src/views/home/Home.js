          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Nous vous remercions de votre intérêt à participer à notre
                  étude sur la perception de la valeur de l'information,
                  conduite par l'Institut Méditerranéen des Sciences de
                  l'Information et de la Communication (IMSIC). Avant de
                  débuter, veuillez lire attentivement les informations
                  suivantes et donner votre consentement pour participer.
                </Typography>
                <Typography
                  sx={{
                    fontFamily: 'Poppins, sans-serif',
                ...
                >
                  ...
                  l'information à travers différents scénarios présentés sur
                  cette plateforme interactive. Les résultats nous aideront à
                  mieux saisir les critères utilisés par différents groupes pour
                  juger l'importance des informations.
                </Typography>
                <Typography
                  sx={{
                    fontFamily: 'Poppins, sans-serif',
                ...
                >
                  ...
                  série de scénarios qui vous seront présentés sur notre site
                  web. Chaque scénario vous proposera plusieurs réponses
                  possibles, et vous devrez choisir celle qui reflète le mieux
                  votre opinion sur la valeur de l'information dans le contexte
                  donné.
                </Typography>
                <Typography
                  sx={{
                ...
                >
                  ...
                  Vous avez le droit de vous retirer de l'étude à tout moment
            ...
            >
              En cliquant sur le bouton ci-dessous et en continuant à participer
              à cette étude, vous confirmez que vous avez lu et compris les
              informations fournies concernant votre participation. Vous
              acceptez de participer à cette étude sur la base du volontariat et
              vous êtes conscient que vous pouvez retirer votre consentement et
              cesser la participation à tout moment.
            </Typography>
